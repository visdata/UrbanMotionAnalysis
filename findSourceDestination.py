...
from util.SrcDstJudgeClass import SrcDstJudge
...
def main(argv):
	...
	city, stdindir, inum, onum, jnum = 'beijing', '/datahouse/tripflow/labelData-30-800-TJ', 9, 20, 20
	stdoutdir = '/datahouse/tripflow/SRCDST-TJ'

	#city, stdindir, inum, onum, jnum = 'beijing', 'C:\Users\lenovo\Desktop', 0, 20, 20
	#stdoutdir = 'C:\res'
	...
	# 处理剩余数据进文件
	# 合并操作
	path = os.path.join(stdoutdir, 'tj-byday-tf')
