...
from SrcDstJudgeClass import SrcDstJudge
...
def main(argv):
	...
	city, stdindir, inum, onum, jnum = 'beijing', '/datahouse/tripflow/labelData-30-800-BJ', 9999, 20, 20
	stdoutdir = '/datahouse/tripflow/SRCDST-BJ'
